...
namespace CognitiveServices.ViewModels
{
    public class ComputerVisionViewModel : INotifyPropertyChanged
    {
        ...
        /// </summary>
        private const string ComputerVisionApiKey = "2778454d061a4a6d97c70cbe2aa95e11";
        private readonly ComputerVisionService _computerVisionService = new ComputerVisionService(ComputerVisionApiKey);
        private const string EmotionApiKey = "e5827a3460b44dfdb1a2a196e703c98f";
        private readonly EmotionService _emotionService = new EmotionService(EmotionApiKey);
        private string _imageUrl = "https://3dprint.com/wp-content/uploads/2015/09/3dp_nutellalock_nutella_jar.jpg";
        //"http://arabspring-news.com/wp-content/uploads/2015/02/2aw12.jpg";
        //"http://arabspring-news.com/wp-content/uploads/2015/02/2aw12.jpg";
